<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i> Edit Animations</h1>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <?php  endif;?>
        <form class="settings" onsubmit="return validateForm()" name="myForm" action="<?php  echo site_url('merchandise/admin/editanimations/'.$pack['id'])?>" method="post" accept-charset="utf-8">
          <div class="tile-body">
			...
			<div class="form-group">
              ...
              <input class="form-control" type="text" name="type" value="<?=$pack['ani_type']?>"/>
            </div>
            <div class="form-group">
              <label class="control-label">Animation Category</label>
              <input class="form-control" type="text" name="cate" value="<?=$pack['ani_category']?>"/>
            </div>
			
			<div class="form-group">
              <label class="control-label">Animation Image</label>
              <input class="form-control" type="text" name="img" value="<?=$pack['ani_image']?>"/>
            </div>
			<div class="form-group">
...
<div class="container">
  <div class="content wide">
    <h1 id="page">
      ...
      <p style="float: right;"><a href="<?php  echo site_url('merchandise/admin/animations')?>">
        <?php  echo "Animations" ;?>
        </a></p>
    </h1>
    <br class="clearfloat" />
...
<form action="<?php  echo site_url('merchandise/admin/editanimations/'.$pack['id'])?>" method="post" style="margin: 2% 14%;">
  <table>
    <tr>
    ...
    <tr>
      ...
      <td><input class="textn" type="text" name="type" value="<?=$pack['ani_type']?>"/></td>
    </tr>
    <tr>
      <td><label class="nlables">Animations Category</label></td>
      <td><input class="textn" type="text" name="cate" value="<?=$pack['ani_category']?>"/></td>
    </tr>
    <tr>
      <td><label class="nlables">Animation Image</label></td>
      <td><input class="textn" type="text" name="img" value="<?=$pack['ani_image']?>"/></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" style="text-align: center;"><input class="textn" type="submit" style="width: 150px;" name="prodsub" value="Edit Animation" /></td>
    </tr>
  </table>
</form>
<script>
