		...
		<div class="media-aset">
			...
			<div class="col-2">
				...
				<?php }else if($media['media_type_id']==2){  ?>
					...
					<a href="<?php  echo site_url('member/mediadetail/'.$media['user_media_id'])?>" data-lity><img src="<?=base_url()?>application/views/<?php echo $this->system->theme_dir . $this->system->theme ?>/images/video-icon.png" alt="video"></a>
				...
				<a  onclick="getmydoc('<?php  echo $media['media']?>')"><img src="<?=base_url()?>media/media_type/photo/thumb/<?php echo  $media['media']; ?>" alt="Photo"></a>
