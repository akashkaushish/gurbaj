      ...
      <div class="col-sm-12 col-md-8 col-md-offset-2">
        <div class="form-content">
          ...
          <form class="form-horizontal" onsubmit="return validateForm()" enctype="multipart/form-data" name="myForm" action="<?php echo site_url('member/updatepassword/'.$key)?>" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Confrim Password</label>
              <div class="col-sm-8">
                <input type="password" id="passconf" name="passconf" class="form-control input-solid" placeholder="Confrim Password" required>
              </div>
            </div>
            <div class="form-group">
