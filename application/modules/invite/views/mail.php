  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <?php  endif;?>
        <form class="settings" onsubmit="return validateForm()" name="myForm" action="<?php  echo site_url('email/admin/addmails')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
          <div class="tile-body">
