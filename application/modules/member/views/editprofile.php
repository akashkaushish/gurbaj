  ...
  <div class="col-xl-12">
    <div class="card bg-default">
      ...
      <div class="card-body">
        ...
        <form class="form-horizontal" method="POST" action="<?php echo site_url('member/editprofile')?>" >
          <div class="form-row">
            <div class="col-md-4 mb-3">
              <label class="form-control-label">First Name*</label>
              <input type="text" name="first_name" placeholder="First Name" value="<?php echo $userdetail['fname'];?>" class="form-control input-solid" required>
              <div class="valid-feedback"> Looks good! </div>
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-control-label">Last Name*</label>
              <input type="text" name="last_name" placeholder="Last Name" value="<?php echo $userdetail['lname'];?>" class="form-control input-solid" required>
              <div class="valid-feedback"> Looks good! </div>
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-control-label">Email*</label>
              <input type="text" name="email" placeholder="Email" value="<?php echo $userdetail['email'];?>" class="form-control input-solid" required>
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" name="phone" id="exampleInputEmail1" value="<?php echo $userdetail['phone'];?>" placeholder="Mobile" required>
              <div class="valid-feedback"> Looks good! </div>
            </div>
            <div class="col-md-12">
