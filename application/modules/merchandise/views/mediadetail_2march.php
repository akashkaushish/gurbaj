      ...
      <div>
        <div class="popup-left">
         	<?php if ( $media['media_type_id']==1){?>
				...
				<a  onclick="getmydoc('<?php  echo $media['media']?>')"><img src="<?php echo base_url()?>application/views/<?php echo $this->system->theme_dir . $this->system->theme ?>/images/text-icon011.png" alt="Text"></a>
