          ...
          <table class="table table-bordered table-striped"  id="sampleTable" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $member['level_bonus']; ?></td>
                ...
                <td><?php if($member['is_active'] != 1){?>
                  ...
                  <?php }?>
                   <a href="<?php  echo site_url($module.'/admin/userdownline/'.$member['id'])?>">Downline</a> | <a href="<?php  echo site_url($module.'/admin/edit/'.$member['id'])?>">Edit</a></td>
              </tr>
              <?php  $i++; endforeach;?>
            </tbody>
          </table>
