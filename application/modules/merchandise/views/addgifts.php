...
<div class="container">
  <div class="content wide">
    <h1 id="page">
      ...
      <p style="float: right;"><a href="<?php  echo site_url('merchandise/admin/gifts')?>">
        <?php  echo "Gifts" ;?>
        </a></p>
    </h1>
    <!--  <ul class="manage">
...
<form action="<?php  echo site_url('merchandise/admin/addgifts')?>" method="post" style="margin: 2% 14%;">
  <table>
    ...
    <tr>
      ...
      <td><input class="textn" type="file" name="cate" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" style="text-align: center;"><input class="textn" type="submit" style="width: 150px;" name="prodsub" value="Add Gift" /></td>
    </tr>
  </table>
</form>
<script>
