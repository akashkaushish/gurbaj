  ...
  <?php  if (isset($notice) || $notice = $this->session->flashdata('notification')):?>
    ...
    <?php foreach($media as $media): ?>
		...
		<div class="media-aset">
			...
			<div class="col-4">
				<?php if ( $_SESSION['is_coach']==1 && $_SESSION['is_paid']==1 ){?>
					<a onclick="return confirm('Are you sure that you want to send this information to all?');" href="<?php  echo site_url('member/sentnotificationbyuser/'.$media['user_media_id'])?>">SEND TO ALL</a>
								<a onclick="return confirm('Are you sure that you want to send this information to individual member?');" href="<?php  echo site_url('member/sentmediaindividual/'.$media['user_media_id'])?>">SEND INDIVIDUAL</a>
