...
<div class="app-title">
  <div>
    <h1><i class="fa fa-th-list"></i> Gifts Administration</h1>
  </div>
  <ul class="app-breadcrumb breadcrumb side">
    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
    <li class="breadcrumb-item"> Gifts List</li>
  </ul>
</div>
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      <div class="tile-body">
		...
		<a href="<?php  echo site_url('merchandise/admin/addgifts')?>" class="btn btn-primary float-right"><i class="fa fa-fw fa-lg fa-plus"></i>Add New Gift</a>
        ...
        <table class="table table-hover table-bordered" id="sampleTable" style="width:100%;">
          <thead>
            <tr>
              ...
              <th width="20%"><?php  echo "Gift Name"; ?></th>
              <th width="15%"><?php  echo "Gift Category"; ?></th>
              <th width="15%"><?php  echo "Gift Type"; ?></th>
              <th width="15%"><?php  echo "Gift Image"; ?></th>
              <th width="15%"><?php  echo "Price"; ?></th>
              <th width="15%"><?php  echo "Date"; ?></th>
              <th width="7%"><?php  echo "Edit"; ?></th>
			  <th width="7%"><?php  echo "Delete"; ?></th>
            </tr>
          </thead>
          <tbody>
            <?php  $i = 1; foreach ($gifts as $p): ?>
            ...
            <tr class="<?php  echo $rowClass?>">
              ...
              <td class="card-text"><?php  echo $p['image'];?></td>
              <td><?php  echo $p['price']?></td>
              <td><?php  echo $p['created_date'];?></td>
              <td><a href="<?php  echo site_url($module.'/admin/editgifts/'.$p['id'])?>">
                <?php  echo "Edit"; ?>
                </a></td>
              <td><a onclick="return confirm('Are you sure to delete?');" href="<?php  echo site_url($module.'/admin/deletegifts/'.$p['id'])?>">
                <?php  echo "Delete"; ?>
                </a></td>
            </tr>
            <?php  $i++; endforeach;?>
...
<?php /*?><div class="container">
  <div class="content wide">
    <h1 id="page">
      ...
      <p style="float: right;"><a href="<?php  echo site_url('merchandise/admin/addgifts')?>">
        <?php  echo "Add New Gift" ;?>
        </a></p>
    </h1>
    <br class="clearfloat" />
    <hr />
