...
<div class="thm-container">
  ...
  <form name="loginform" method="POST" action="<?php echo site_url('member/signup')?>">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="email" id="exampleInputEmail1" placeholder="Email" required>
    </div>
    <div class="form-group">
...
<div class="col-md-8"><input type="text" class="form-control" name="phone" id="exampleInputEmail1" placeholder="Mobile" required></div>
  </div>
    </div>
    <div class="form-group">
      <label for="exampleInputEmail1">Refferal Code</label>
      <input type="text" class="form-control" name="ref_code" id="exampleInputEmail1" value="<?php echo $ref_code_link; ?>" placeholder="Refferal Code">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="exampleInputPassword1" name="passconf" placeholder="Confirm Password" required>
    </div>
