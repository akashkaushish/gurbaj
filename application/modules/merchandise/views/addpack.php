<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i> Add Packages</h1>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Add Packages</h3>
        <?php  if (isset($notice) || $notice = $this->session->flashdata('notification')):?>
        <p class="notice">
          <?php  echo $notice;?>
        </p>
        <?php  endif;?>
        <form class="settings" onsubmit="return validateForm()" name="myForm" action="<?php  echo site_url('merchandise/admin/addpackages')?>" method="post" accept-charset="utf-8">
          <div class="tile-body">
            ...
            <div class="form-group">
             ...
             <select class="form-control" name="anima[]" multiple>
          <?php 
...
<form action="<?php  echo site_url('merchandise/admin/addpackages')?>" method="post" style="margin: 2% 14%;">
  <table>
    <tr>
    ...
    <tr>
      ...
      <td><input class="textn" type="text" name="description" /></td>
    </tr>
    <tr>
      <td colspan="2" style="text-align: center;"><input class="textn" type="submit" style="width: 150px;" name="prodsub" value="Add Package" /></td>
    </tr>
  </table>
</form>
<script>
