...
<table class="page-list">
	<thead>
		<tr>
				...
				<?php /*?><th width="10%" colspan="2"><?php echo __("Ordering", $module)?></th><?php */?>
...
<?php if ($i % 2 != 0): $rowClass = 'odd'; else: $rowClass = 'even'; endif;?>
		<tr class="<?php echo $rowClass?>">
				...
				<a href="<?php echo site_url('admin/page/move/down/'. $page['id']. '/' . $search_id . '/' . $start)?>"><img src="<?php echo site_url('application/views/' . $this->system->theme_dir . 'admin/images/movedown.gif')?>" width="16" height="16" title="<?php echo __("Move down", $module)?>" alt="<?php echo __("Move down", $module)?>"/></a></td><?php */?>
