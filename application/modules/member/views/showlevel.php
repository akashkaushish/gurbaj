    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Level Commission</h6>
        </div>
      </div>
    </div>
  </div>
        ...
        <table class="table align-items-center table-dark table-flush">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php //echo $bonus[$i]['commission_percentage']; 
                    if($bonus[$i]['comm_by_level'] == 1){ echo "2%"; }else if($bonus[$i]['comm_by_level'] == 2){ echo "1%"; }else if($bonus[$i]['comm_by_level'] == 3){ echo "1%"; }else if($bonus[$i]['comm_by_level'] == 4){ echo "0.50%"; }else if($bonus[$i]['comm_by_level'] == 5){ echo "0.50%"; }else if($bonus[$i]['comm_by_level'] == 6){ echo "0.25%"; }else if($bonus[$i]['comm_by_level'] == 7){ echo "0.25%"; }
              ?></td>
              <td><?php echo $bonus[$i]['comm_by_level']; ?></td>
              <td><?php echo $bonus[$i]['comm_by_username']; ?> (<?php echo $userdata['my_ref_code']; ?>)</td>
              <td><?php if($bonus[$i]['is_paid'] ==1){ echo "Paid"; }else{ echo "Unpaid"; } ?></td>
            </tr>
            <?php } }else{ ?>
            <tr>
...
<!-- Footer -->
<?php /*?><div class="page_header" data-parallax-bg-image="<?php echo base_url()?>application/views/<?php echo $this->system->theme_dir . $this->system->theme ?>/assets/img/1920x650-6.jpg" data-parallax-direction="">
