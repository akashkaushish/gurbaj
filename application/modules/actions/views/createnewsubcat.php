<?php  $is_active = array("0"=>"No","1"=>"Yes"); ?>

<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i> Add Sound Sub Category</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item"><a href="<?php echo site_url('audio/admin/subcategorylist');?>">Sound Sub Category List</a></li>
      <li class="breadcrumb-item">Add Sound Sub Category</li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <form class="settings" onsubmit="return validateForm()" name="myForm" action="<?php  echo site_url('audio/admin/createsubcat')?>" method="post" accept-charset="utf-8">
          <div class="tile-body">
            <div class="form-group">
              <label class="control-label">Parent Category</label>
              <select id="parent_cat_id" name="parent_cat_id" class="form-control">
                <?php if(!empty($parentcategory)){
			   foreach($parentcategory as $key=>$data){
			   	?>
          ...
          <div class="tile-footer">
            ...
            <a class="btn btn-secondary" href="<?php echo site_url('audio/admin/subcategorylist');?>"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a> </div>
        </form>
      </div>
    </div>
  </div>
...
<?php /*?><div class="content slim">
  <h1 id="settings">
    <?php  echo "Add Sound Sub Category"; ?>
  </h1>
  <?php
    $is_active = array("0"=>"No","1"=>"Yes");
 ?>
  <form class="settings" onsubmit="return validateForm()" name="myForm" action="<?php  echo site_url('audio/admin/createsubcat')?>" method="post" enctype="multipart/form-data">
    <ul>
      <li>
        <input type="submit" name="submit" value="<?php  echo "Save"; ?>" class="input-submit" />
      </li>
      <li><a href="<?php  echo site_url('audio/admin/subcategorylist')?>" class="input-submit last">
        <?php  echo "Cancel"; ?>
        </a></li>
    </ul>
    <br class="clearfloat" />
