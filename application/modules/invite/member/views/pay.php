<section class="pricing-section sec-pad" id="pricing">
  <div class="thm-container">
    <div class="sec-title text-center"> <span>Welcome to the Accrue Payment Center</span>
    ...
    <div class="login-sec">
      <div class="thm-container">
        <div class="login-header">
          <p>Please transfer the package amount in this account number: <b>3CAuAWW1Nd43QpvFstGMEY9W2w84m9t7wA</b> <br/><br/> After that Please enter the Transaction ID in the below textbox. Admin will approve your investment after verification.</p>
        </div>
