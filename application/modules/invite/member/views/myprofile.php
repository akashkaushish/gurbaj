...
<?php  endif; ?>
<h1 id="settings">
  <?php  echo __("Edit your profile", $module)?>
</h1>
<form class="profile" action="<?php  echo site_url('member/profile')?>" method="post" accept-charset="utf-8">
  ...
  :</label>
  <input type="password" name="passconf" value="" id="" class="input-text" />
  <br />
  <?php  
  ...
  <a href="<?php  echo site_url()?>" class="input-submit">
