      ...
      <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
          <div class="haeder-text">
            <h1>Member Login</h1>
            <p>Login your account. It's free and only takes a minute.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12 col-md-8 col-md-offset-2">
        <div class="form-content">
          ...
          <form class="form-horizontal" method="POST" action="<?php echo site_url('member/login')?>">
            <div class="form-group">
              <label class="col-sm-4 control-label">Username</label>
              <div class="col-sm-8">
                <input type="text" name="email" placeholder="Username" class="form-control input-solid">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-4 control-label">Enter Password</label>
              <div class="col-sm-8">
                <input type="password" name="password" placeholder="Password" class="form-control input-solid">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-8 col-sm-offset-4"> <a href="<?php echo site_url('member/forgotpassword');?>" class="form-title">Forgot Password</a> | <a href="<?php echo site_url('member/signup');?>" class="form-title">Signup</a> </div>
            </div>
            <div class="form-group">
