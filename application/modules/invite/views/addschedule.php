<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i> Add New Schedule</h1>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Add New Schedule</h3>
        <?php  if (isset($notice) || $notice = $this->session->flashdata('notification')):?>
        <p class="notice">
          <?php  echo $notice;?>
        </p>
        <?php  endif;?>
        <form class="settings" onsubmit="return validateForm()" name="myForm" action="<?php  echo site_url('email/admin/addschedule')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
          <div class="tile-body">
              ...
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <div class="input-append date form_datetime">
                    <input class="form-control" name="datetime" type="text" value="" placeholder="Click to Select Date & Time">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="deselect" name="users[]" multiple style="height: 300px;">
                    <?php 
                      ...
                      foreach ($d as $e) {                    
                    ?>
                      <option value="<?=$e['email']?>"><?=$i?>) <?=$e['name']?>( <?=$e['email']?> )</option>
                    <?php
                      $i++;
                      }
                    ?>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" style="height: 200px;" name="remark"></textarea>
            </div>
