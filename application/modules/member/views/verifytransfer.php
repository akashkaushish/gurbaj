    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Transfer Funds Verification To Your Friend</h6>
          <h6 class="h2 text-white d-inline-block mb-0">Wallet Amount: <b>$
    ...
    <div class="card bg-default">
      <div class="card-header bg-transparent border-0">
        <div class="row align-items-center">
          <div class="col">
            <h3 class="text-white mb-0">Please enter the verification code (OTP), to proceed. </h3>
          </div>
        </div>
      </div>
      <div class="card-body">
